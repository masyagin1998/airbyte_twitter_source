...
import pytest
from source_twitter.source import TwitterStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TwitterStream, "path", "v0/example_endpoint")
    mocker.patch.object(TwitterStream, "primary_key", "test_primary_key")
    mocker.patch.object(TwitterStream, "__abstractmethods__", set())
